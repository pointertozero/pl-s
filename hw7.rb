...
class LineSegment < GeometryValue
  ...
  def intersectWithSegmentAsLineResult seg
    ...
    if real_close(seg1.x1, seg1.x2)
      # then segs are on vertical line
      if seg1.y1 > seg2.y1
        # swap
        seg1, seg2 = seg2, seg1
      end
      ...
      if real_close(seg1.y2, seg2.y1)
        # just touching
        Point.new(seg1.x1, seg1.y2)
      elsif seg1.y2 < seg2.y1
        # disjoint
        NoPoints.new
      elsif seg1.y2 > seg2.y2
        # seg2 inside of seg1
      # LineSegment.new(seg1.x1, seg2.y1, seg1.x1, seg2.y2)
        seg2
      else
        # overlapping
        LineSegment.new(seg1.x1, seg2.y1, seg1.x1, seg1.y2)
      end

    else
      # segs on non-vertical line
      if seg1.x1 > seg2.x1
        # swap
        seg1, seg2 = seg2, seg1
      end
